...
INSERT INTO categories(name) Values ('prancha');
INSERT INTO categories(name) Values ('bodyboard');
INSERT INTO categories(name) Values ('longboard');
INSERT INTO categories(name) Values ('acessorios');
...
--remove sql cascade products and files
